...
.method private final mediationLogMessage(Lcom/usercentrics/sdk/mediation/data/ConsentApplyResult;)Ljava/lang/String;
    ...
    const-string p1, " - Unable to pass"

    invoke-virtual {v1, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    if-eqz v0, :cond_1

    const-string p1, "Granular"
    ...
    const-string p1, " consent. Please, report this issue to Usercentrics. https://usercentricssupport.zendesk.com/hc/en-us/requests/new"
...
.method public logInitialState(Ljava/util/List;)V
    ...
    const-string p1, " Services are supported: "
